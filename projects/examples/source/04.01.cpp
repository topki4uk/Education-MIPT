...
//
// content : Declaration template
//
// content : Type Template Parameters
//
...
//
// content : Service C++ Insights
//
// content : Default Arguments
//
// content : Metafunction std::common_type
//
...
auto max_v8(auto x, auto y) // support : https://cppinsights.io
{
	return x < y ? y : x;
}
...
int main()
{
    assert(equal(max_v1(1,   2  ), 2)); // support : https://cppinsights.io

	assert(equal(max_v1(1.0, 2.0), 2)); // support : https://cppinsights.io
...
//  -----------------------------------------------------------------------
	...
	assert(equal(max_v8(1, 2.0), 2)); // support : https://cppinsights.io
